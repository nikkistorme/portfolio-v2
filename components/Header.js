        ...
        <HeaderContent>
          <HeaderTitleContainer>
            ...
            <h4 className="description">
              Custom, functional sites for individuals and businesses
            </h4>
          </HeaderTitleContainer>
          <HeaderPageTitle>
            <div className="icons">
              <a href="mailto:nikkistorme@gmail.com" target="_blank">
                <img src="/mail-icon.png" alt="Mail Icon" />
              </a>
              <a href="https://angel.co/nicholas-bright-3/" target="_blank">
                <img
                  className="angel-list"
                  src="/AngelList_Black_Victory_Hand.png"
                  alt="AngelList Icon"
                />
              </a>
              <a
                ...
                target="_blank"
              >
                <img src="/linkedin-black.png" alt="LinkedIn Icon" />
              </a>
              <a href="https://github.com/Nikkistorme" target="_blank">
